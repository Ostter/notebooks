...
import { fetchNotebooks, loadMoreNotebooks, fetchCategories } from "actions";
import { getNotebooks } from "selectors";

class Notebooks extends Component {
  //fetch данных при монтировании компонента, запускаем actions
  componentDidMount() {
      ...
      <div>
        <div className="books row">
          {notebooks.map((notebook, index) =>
            this.renderNotebook(notebook, index)
          )}
        </div>
        <div className="row">
