...
class Notebook extends Component {
  ...
  renderFields() {
    ...
    const columnFields = R.compose(
      //смешиваем несколько методов
      R.toPairs, //получаем массив из массивов формата ключ-значение
      R.pick([
        //берем только эти поля из notebook
        "screenSize",
        "touchScreen",
        "hardDriveType",
        "hardDriveCapacity",
    ...
    return (
      <div className="view-container">
        <div className="container">
          <div className="row">
            <div className="col-md-9">{notebook && this.renderContent()}</div>
          </div>
          <div className="row">
            <div className="col-md-3">{notebook && this.renderBottombar()}</div>
          </div>
        </div>
      </div>
    );
